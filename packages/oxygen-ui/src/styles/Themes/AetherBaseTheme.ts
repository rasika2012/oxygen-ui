...
/**
 * AetherBaseTheme - Base theme for flat design with solid colors and no blur effects
 ...
 * Extend this theme to create color variants (AetherGrey, AetherColor, etc.)
 */
const AetherBaseTheme = extendTheme(OxygenThemeBase, {
  shape: {
    borderRadius: 12,
  },
  components: {
...
// Aether base theme uses solid colors, but we keep gradient property for compatibility
// (set to none to indicate flat design)
const aetherBaseGradient = {
  gradient: {
    primary: 'none',
  },
};

Object.assign(AetherBaseTheme, aetherBaseGradient);
if (AetherBaseTheme.vars) {
  Object.assign(AetherBaseTheme.vars, aetherBaseGradient);
}

export default AetherBaseTheme as OxygenTheme;
